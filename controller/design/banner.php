	...
	protected function getForm() {
		...
		foreach ($banner_images as $key => $value) {
			foreach ($value as $banner_image) {
				...
				if (is_file(DIR_IMAGE . $banner_image['mbl_image'])) {
					$mbl_image = $banner_image['mbl_image'];
                    $mbl_thumb = $banner_image['mbl_image'];
				} else {
                    $mbl_image = '';
                    $mbl_thumb = 'no_image.png';
				}
				...
				$data['banner_images'][$key][] = array(
                    ...
                    'mbl_thumb'      => $this->model_tool_image->resize($mbl_thumb, 100, 100),
