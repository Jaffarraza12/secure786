...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['product'])) {
            ...
            $products = $this->model_catalog_information->getInformationProducts($this->request->get['information_id']);
        } else {
            $products = array();
        }
        ...
        if (isset($this->request->post['type'])) {
            ...
            $data['type'] = $information_info['type'];
        } else {
            $data['type'] = true;
        }
        ...
        if (isset($this->request->post['department'])) {
            ...
            $data['department'] = $information_info['department'];
        } else {
            $data['department'] = true;
        }

        $data['departments'] = $this->model_catalog_information->getBlogDepartment();
        ...
        if (isset($this->request->post['category'])) {
            ...
            $data['categories'] = $this->model_catalog_information->getBlogCategory($information_info['department']);
        } else {
            $data['category'] = true;
        }
        ...
        if (isset($this->request->post['related_product'])) {
            ...
            $data['related_product'] = $information_info['related_product'];
        } else {
        ...
        if (isset($this->request->post['related_article'])) {
            ...
            $data['related_article'] = $information_info['related_article'];
        } else {
        ...
        } elseif ($information_info['image']&& is_file(DIR_IMAGE . $information_info['image'])) {
            $data['image'] = $this->model_tool_image->resize($information_info['image'], 100, 100);
            $data['image_path'] = $information_info['image'];
        } else {
        ...
        if (isset($this->request->post['product_id'])) {
            ...
            $data['product_id'] = $information_info['product_id'];
        } else {
            $data['product_id'] = '';
        }
	...
	public function category(){
        $json = array();
        $this->load->model('catalog/information');
        $categories = $this->model_catalog_information->getBlogCategory($this->request->get['id']);
        if ($categories) {
